...
contract MockSmartAccount is Initializable, Account, EIP712, ERC7739, AccountERC7579Hooked, SignerECDSA {
    constructor() EIP712("MockSmartAccount", "1") SignerECDSA(msg.sender) {}

    function initializeAccount(address owner) public initializer {
        _setSigner(owner);
    }
